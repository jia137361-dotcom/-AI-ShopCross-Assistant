...
_IMAGE_BASE = "?auto=format&fit=crop&w=900&h=560&q=82"

# 图片来自 Unsplash 的公开图片 CDN。这里按商品语义分配，而不是用品牌首字母占位图；
# 每个商品 ID 都会获得稳定 URL，后续接真实商家图时只需覆盖 Product.image_url。
_PRODUCT_IMAGE_IDS = {
    "P1004": "photo-1599955051125-571f47e04316", "P1022": "photo-1599955051125-571f47e04316", "P1023": "photo-1599955051125-571f47e04316",
    "P1005": "photo-1583863788434-e58a36330cf0", "P1024": "photo-1583863788434-e58a36330cf0", "P1025": "photo-1583863788434-e58a36330cf0", "P1026": "photo-1583863788434-e58a36330cf0", "P1027": "photo-1583863788434-e58a36330cf0", "P1028": "photo-1583863788434-e58a36330cf0", "P1029": "photo-1583863788434-e58a36330cf0", "P1030": "photo-1583863788434-e58a36330cf0", "P1054": "photo-1583863788434-e58a36330cf0",
    "P1006": "photo-1495100497150-fe209c585f50", "P1031": "photo-1495100497150-fe209c585f50", "P1032": "photo-1495100497150-fe209c585f50", "P1033": "photo-1495100497150-fe209c585f50", "P1034": "photo-1495100497150-fe209c585f50", "P1035": "photo-1495100497150-fe209c585f50", "P1036": "photo-1495100497150-fe209c585f50", "P1037": "photo-1495100497150-fe209c585f50", "P1055": "photo-1495100497150-fe209c585f50", "P1056": "photo-1495100497150-fe209c585f50", "P1057": "photo-1495100497150-fe209c585f50",
    "P1008": "photo-1504280390367-361c6d9f38f4", "P1010": "photo-1504280390367-361c6d9f38f4", "P1038": "photo-1504280390367-361c6d9f38f4", "P1039": "photo-1504280390367-361c6d9f38f4", "P1040": "photo-1504280390367-361c6d9f38f4", "P1041": "photo-1504280390367-361c6d9f38f4", "P1042": "photo-1504280390367-361c6d9f38f4", "P1043": "photo-1504280390367-361c6d9f38f4", "P1044": "photo-1504280390367-361c6d9f38f4", "P1045": "photo-1504280390367-361c6d9f38f4", "P1046": "photo-1504280390367-361c6d9f38f4", "P1047": "photo-1504280390367-361c6d9f38f4", "P1048": "photo-1504280390367-361c6d9f38f4",
}


def _image_url(product_id: str, category: str) -> str:
    image_id = _PRODUCT_IMAGE_IDS.get(product_id)
    if image_id is None:
        image_id = "photo-1553062407-98eeb64c6a62" if category == "旅行装备" else "photo-1495100497150-fe209c585f50"
    return f"https://images.unsplash.com/{image_id}{_IMAGE_BASE}"
...
def build_seed_products() -> list[Product]:
    ...
    for product in products:
        product.image_url = _image_url(product.product_id, product.category)
    return products
